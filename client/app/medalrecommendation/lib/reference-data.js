...
const INDIVIDUAL_AWARDS = Object.freeze([
  ...
  Object.freeze({
    ...
    minimumSentences: 3,
    guidance: 'Explain the lead-up, the single act under fire, and the outcome.',
    eligibility: 'The recommendation must focus on one specific act under enemy fire.',
  ...
  Object.freeze({
    ...
    eligibility: 'The act must be critical to success and the recipient must have survived.',
    characterRequired: false,
  ...
  Object.freeze({
    ...
    endingTemplate:
      "{FULLNAME}'s skills and heroic actions reflect great credit upon themselves and the 7th Cavalry Gaming Regiment.",
    minimumSentences: 3,
    guidance: "Explain the lead-up, the pilot's extraordinary act, and the outcome.",
    eligibility:
  ...
  Object.freeze({
    ...
    eligibility: 'Recipient must have served in an official leadership position and survived.',
    characterRequired: false,
    survivalRule: 'Must survive',
    flightWingsRequired: false,
...
const UNIT_AWARDS = Object.freeze([
  Object.freeze({
    ...
    eligibility: 'Requires an official organized event and at least four recipients.',
    characterRequired: false,
    allowedCharacter: 'Fixed by template',
  }),
  ...
  Object.freeze({
    ...
    eligibility: 'Requires an official organized event, total mission success or all official matches won, and at least four recipients.',
    characterRequired: true,
    allowedCharacter: 'Skillful|Heroic',
  }),
]);
...
const SERVICE_REFERENCE_CHOICES = Object.freeze({
  ...
  narrativeLeads: Object.freeze(['distinguished themselves by', 'contributed by']),
...
const SERVICE_AWARD_DEFINITIONS = Object.freeze([
  {
    ...
    minimumSentences: 2,
    openingTemplate: 'For providing outstanding service to {NON_COMBAT_DEPARTMENT}.',
    endingTemplate:
    ...
    criteria: 'Outstanding service to a non-combat department to which the recipient is not assigned.',
    guidance: 'Describe the recipient’s specific contributions to the selected department and explain the effect of that service.',
    eligibility: 'The recipient must not have been assigned to the benefited non-combat department during the cited service.',
    choices: {},
  ...
  },
  {
    ...
    criteria: 'Providing financial, physical, mental, emotional, gaming, or computer-related aid to a fellow member, including initiating a Garry Owen for a member in need.',
    guidance: 'Describe how the recipient provided help or aid and explain how it benefited the fellow member.',
    eligibility: 'The narrative must identify a qualifying form of aid provided to a 7th Cavalry member.',
    choices: {},
  ...
  },
  {
    ...
    criteria: 'Contributions to any area of the Regiment, or selection as Enlisted of the Quarter.',
    guidance: 'Describe the recipient’s contributions to the affected area and explain their results or impact.',
    eligibility: 'The recommendation must document qualifying contributions or an Enlisted of the Quarter selection.',
    choices: {},
  ...
  },
  {
    ...
    criteria: 'Attendance and contributions at multiple section practices outside the recipient’s assigned unit while consistently attending their own.',
    guidance: 'Describe the outside section-practice attendance and the recipient’s contributions to the benefited combat-line unit.',
    eligibility: 'The recipient must continue attending their assigned section practices, and the benefited combat-line unit commander must recommend the award.',
    choices: {},
  ...
  },
  {
    ...
    minimumSentences: 3,
    openingTemplate: 'For distinguished contributions to {AFFECTED_UNIT_OR_AREA}.',
    endingTemplate:
    ...
    criteria: 'Distinguished contributions to any area of the Regiment, or selection as Enlisted or NCO of the Quarter.',
    guidance: 'Describe the distinguished contributions to the selected unit or area and explain their impact.',
    eligibility: 'The recommendation must document distinguished contributions or a qualifying Enlisted or NCO of the Quarter selection.',
    choices: {},
    imageUrl: 'https://wiki.7cav.us/images/d/dc/ARCOM.jpg',
    filePageUrl: 'https://wiki.7cav.us/wiki/Awards_and_Decorations',
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        helpText: 'Enter the unit to which the recipient belonged during the cited service.',
      },
      {
        key: 'narrativeLead',
    ...
    criteria: 'Significant contributions to a combat-line unit outside the recipient’s assignment and outside ordinary section-practice attendance.',
    guidance: 'Describe the actions or contributions, how they benefited the selected combat-line unit, and the recipient’s role while assigned elsewhere.',
    eligibility: 'The benefited and assigned units must be different; section-practice attendance alone does not qualify, and the benefited unit commander must recommend the award.',
    choices: {},
  ...
  },
  {
    ...
    criteria: 'Exceptional service or contributions that significantly improve unit health and morale, or selection as Enlisted, NCO, or Officer of the Quarter.',
    guidance: 'Describe the exceptional service or contributions and explain the significant positive effect on unit health or morale.',
    eligibility: 'Normally limited to one award per person in any six-month period; the limit does not apply to Of-the-Quarter awards.',
    choices: {},
  ...
  },
  {
    ...
    criteria: 'A single, significant, and distinguished meritorious contribution to any area of the Regiment.',
    guidance: 'Keep the narrative focused on the one qualifying contribution and explain why it was significant and distinguished.',
  ...
  },
  {
    ...
    minimumSentences: 3,
    openingTemplate: 'For {SOLDIERS_OPENING_PHRASE} to {BENEFITED_UNIT_OR_AREA}.',
    endingTemplate:
    ...
    criteria: 'Multiple significant and distinguished meritorious contributions to any area of the Regiment requiring significant time investment.',
    guidance: 'Describe multiple qualifying contributions, the time invested, and their collective effect on the benefited unit or area.',
    eligibility: 'Limited to one award per person in any six-month period.',
    choices: {},
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        helpText: 'Enter the organization that should be credited in the closing sentence.',
      },
      {
        key: 'startMonth',
        label: 'Start Month',
    ...
    criteria: 'Exceptional service in a secondary billet over the course of one year, or selection as Departmental Clerk of the Year.',
    guidance: 'Describe the recipient’s exceptional service throughout the cited period and connect it to the secondary billet and credited department.',
    eligibility: 'Limited to one award per person per year and not available for secondary Lead billets or higher.',
    choices: {},
  ...
  },
  {
    ...
    criteria: 'Exceptionally meritorious leadership of a secondary billet or operations over the course of one year, or selection as Departmental Staff of the Year.',
    guidance: 'Describe the recipient’s leadership throughout the cited period and explain its effect on the secondary billet or Operations AO.',
    eligibility: 'The recipient must be an NCO or officer serving as a sub-department Lead or higher, and the award is limited to once per person per year.',
    choices: {},
  ...
  },
  {
    ...
    criteria: 'Distinguished service in a primary non-leadership billet, or selection as Battalion or Regimental Enlisted of the Year.',
    guidance: 'Describe the distinguished service throughout the cited period and explain its effect on the credited organizational element.',
    eligibility: 'Limited to one award per person per year and not available for primary leadership billets.',
    choices: {},
  ...
  },
  {
    ...
    criteria: 'Exceptionally meritorious leadership of a primary billet over the course of one year, or selection as Battalion or Regimental NCO or Officer of the Year.',
    guidance: 'Describe the recipient’s leadership throughout the cited period and explain its effect on their troopers and organizational element.',
    eligibility: 'The recipient must be an NCO or officer serving in a qualifying primary leadership billet, or receive a qualifying Of-the-Year selection.',
    choices: {},
  ...
  },
  {
    ...
    criteria: 'Excellent meritorious performance of duties and multiple significant, distinguished contributions that positively affect multiple areas of the Regiment.',
    guidance: 'Describe the group’s multiple contributions, how it performed its duties, and the effect across the benefited areas.',
    eligibility: 'The recognized group must be section or sub-department level or higher, and the award must be recommended by Battalion Staff, Departmental HQ, or higher. This is a Meritorious Service Medal equivalent.',
    choices: {},
  ...
  },
  {
    ...
    criteria: 'Superior performance of duties by a section-level unit or higher, or a sub-department or higher.',
    guidance: 'Describe the group’s superior performance and explain the effect of its service or contributions on the benefited unit.',
    eligibility: 'Each Battalion or Department may award one per six months. This is an Army Commendation Medal equivalent.',
    choices: {},
...
function validateServiceAwardDefinitions_() {
  const errors = [];
  const ids = new Set();
  const allowedComponents = new Set(['text', 'organization', 'select', 'month', 'year']);
  ...
  const suggestionSources = new Set(['primaryBillets', 'secondaryBillets', 'allBillets']);
  ...
  SERVICE_AWARD_DEFINITIONS.forEach((award, index) => {
    ...
    if (ids.has(award.id)) errors.push(`Duplicate Service award id: ${award.id}.`);
    ids.add(award.id);
    ...
    if (!Number.isInteger(award.minimumSentences) || award.minimumSentences < 1) {
    ...
    fields.forEach((field) => {
      ...
      if (!allowedComponents.has(field.component)) {
        errors.push(`${fieldPrefix} has unsupported component ${field.component}.`);
      }

      if (field.component === 'organization' && !organizationSources.has(field.optionsSource)) {
        errors.push(`${fieldPrefix} has invalid organization options source.`);
      }

      if (field.component === 'select' && !choiceSources.has(field.optionsSource)) {
        errors.push(`${fieldPrefix} has invalid choice options source.`);
      }

      if (field.suggestionsSource && !suggestionSources.has(field.suggestionsSource)) {
    ...
    templateTokens.forEach((token) => {
      if (!fieldTemplateTokens.has(token) && !specialTemplateTokens.has(token)) {
        errors.push(`${award.id} contains unsupported template token ${token}.`);
      }
    });

    const periodKeys = ['startMonth', 'startYear', 'endMonth', 'endYear'];
    const periodFieldCount = periodKeys.filter((key) => fieldKeys.has(key)).length;

    if (periodFieldCount > 0 && periodFieldCount !== periodKeys.length) {
      errors.push(`${award.id} contains an incomplete service-period field set.`);
    }

    if (templateTokens.includes('SERVICE_PERIOD') && periodFieldCount !== periodKeys.length) {
      errors.push(`${award.id} uses SERVICE_PERIOD without all service-period fields.`);
    }
  });
  ...
  const unit = SERVICE_AWARD_DEFINITIONS.filter((award) => award.scope === 'unit').length;

  if (individual !== 13) errors.push(`Expected 13 Service Medals; found ${individual}.`);
...
function buildOrganizationReference_(roster) {
  ...
  const patterns = [
    ['sections', new RegExp(`\\b[A-Z0-9]+\\/\\d+\\/[A-Z]\\/${formation}\\b`, 'g')],
  ...
  const lineOrganizations = [...battalions, ...companies, ...platoons, ...sections];
  const approvedOrganizations = mergeOrganizationValues_(supportDepartments, lineOrganizations);
...
function getOrganizationBillets_(person) {
  const source = Array.isArray(person && person.billets)
    ...
    : [
        ...
        ...(Array.isArray(person && person.secondaryBillets) ? person.secondaryBillets : []),
      ];
  const seen = new Set();
...
function addSupportDepartmentPrefix_(organizations, billet) {
  const match = cleanOrganizationValue_(billet).match(/^([A-Z][A-Z0-9]{1,11})\b/u);
...
function addOrganizationValue_(organizations, value) {
  const clean = cleanOrganizationValue_(value);
  const normalized = clean.toUpperCase();
  if (clean && !organizations.has(normalized)) organizations.set(normalized, clean);
}
